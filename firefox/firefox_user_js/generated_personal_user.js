...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "START: Oh yes, the Norwegian Blue... what's wrong with it?");

 /* 0000: disable about:config warning ***/
 user_pref("browser.aboutConfig.showWarning", false);
 
 /*** [SECTION 0100]: STARTUP ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "0100 syntax error: the parrot's dead!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "0200 syntax error: the parrot's definitely deceased!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "0300 syntax error: the parrot's not pinin' for the fjords!");
 /** RECOMMENDATIONS ***/
...
// XXX removed because it is already default or I dont need XXX  user_pref("browser.shopping.experience2023.enabled", false); // [DEFAULT: false]
...
// XXX removed because it is already default or I dont need XXX  user_pref("browser.crashReports.unsubmittedCheck.autoSubmit2", false); // [DEFAULT: false]
 ...
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "0400 syntax error: the parrot's passed on!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "0600 syntax error: the parrot's no more!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("network.predictor.enable-prefetch", false); // [FF48+] [DEFAULT: false]
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "0700 syntax error: the parrot's given up the ghost!");
 /* 0702: set the proxy server to do any DNS lookups when using SOCKS
  * e.g. in Tor, this stops your local DNS server from knowing your Tor destination
  * as a remote Tor node will handle the DNS request
  * [1] https://trac.torproject.org/projects/tor/wiki/doc/TorifyHOWTO/WebBrowsers ***/
// XXX removed because it is already default or I dont need XXX  user_pref("network.proxy.socks_remote_dns", true);
 /* 0703: disable using UNC (Uniform Naming Convention) paths [FF61+]
  * [SETUP-CHROME] Can break extensions for profiles on network shares
  * [1] https://bugzilla.mozilla.org/1413868 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("network.file.disable_unc_paths", true); // [HIDDEN PREF]
...
// XXX removed because it is already default or I dont need XXX  user_pref("network.gio.supported-protocols", ""); // [HIDDEN PREF] [DEFAULT: "" FF118+]
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "0800 syntax error: the parrot's ceased to be!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("browser.urlbar.fakespot.featureGate", false); // [FF130+] [DEFAULT: false]
 user_pref("browser.urlbar.mdn.featureGate", false); // [FF117+] [HIDDEN PREF]
// XXX removed because it is already default or I dont need XXX  user_pref("browser.urlbar.pocket.featureGate", false); // [FF116+] [DEFAULT: false]
// XXX removed because it is already default or I dont need XXX  user_pref("browser.urlbar.weather.featureGate", false); // [FF108+] [DEFAULT: false]
// XXX removed because it is already default or I dont need XXX  user_pref("browser.urlbar.yelp.featureGate", false); // [FF124+]
...
// XXX removed because it is already default or I dont need XXX  user_pref("browser.formfill.enable", false);
...
// XXX removed because it is already default or I dont need XXX  user_pref("browser.search.separatePrivateDefault", true); // [FF70+]
// XXX removed because it is already default or I dont need XXX  user_pref("browser.search.separatePrivateDefault.ui.enabled", true); // [FF71+]
 
 /*** [SECTION 0900]: PASSWORDS
    [1] https://support.mozilla.org/kb/use-primary-password-protect-stored-logins-and-pas
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "0900 syntax error: the parrot's expired!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("signon.autofillForms", false);
 /* 0904: disable formless login capture for Password Manager [FF51+] ***/
// XXX removed because it is already default or I dont need XXX  user_pref("signon.formlessCapture.enabled", false);
...
// XXX removed because it is already default or I dont need XXX  user_pref("network.auth.subresource-http-auth-allow", 1);
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "1000 syntax error: the parrot's gone to meet 'is maker!");
 /* 1001: disable disk cache
  * [NOTE] We also clear cache on exit (2811)
  * [SETUP-CHROME] If you think disk cache helps perf, then feel free to override this ***/
// XXX removed because it is already default or I dont need XXX  user_pref("browser.cache.disk.enable", false);
 /* 1002: set media cache in Private Browsing to in-memory and increase its maximum size
  * [NOTE] MSE (Media Source Extensions) are already stored in-memory in PB ***/
// XXX removed because it is already default or I dont need XXX  user_pref("browser.privatebrowsing.forceMediaMemoryCache", true); // [FF75+]
// XXX removed because it is already default or I dont need XXX  user_pref("media.memory_cache_max_size", 65536);
 /* 1003: disable storing extra session data [SETUP-CHROME]
  * define on which sites to save extra session data such as form content, cookies and POST data
  * 0=everywhere, 1=unencrypted sites, 2=nowhere ***/
// XXX removed because it is already default or I dont need XXX  user_pref("browser.sessionstore.privacy_level", 2);
 /* 1005: disable automatic Firefox start and session restore after reboot [FF62+] [WINDOWS]
  * [1] https://bugzilla.mozilla.org/603903 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("toolkit.winRegisterApplicationRestart", false);
 /* 1006: disable favicons in shortcuts [WINDOWS]
  * URL shortcuts use a cached randomly named .ico file which is stored in your
  * profile/shortcutCache directory. The .ico remains after the shortcut is deleted
  * If set to false then the shortcuts use a generic Firefox icon ***/
// XXX removed because it is already default or I dont need XXX  user_pref("browser.shell.shortcutFavicons", false);
 ...
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "1200 syntax error: the parrot's a stiff!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("security.ssl.require_safe_negotiation", true);
...
// XXX removed because it is already default or I dont need XXX  user_pref("security.tls.enable_0rtt_data", false);
...
// XXX removed because it is already default or I dont need XXX  user_pref("security.OCSP.enabled", 1); // [DEFAULT: 1]
...
// XXX removed because it is already default or I dont need XXX  user_pref("security.OCSP.require", true);
 
 /** CERTS / HPKP (HTTP Public Key Pinning) ***/
 /* 1223: enable strict PKP (Public Key Pinning)
  * 0=disabled, 1=allow user MiTM (default; such as your antivirus), 2=strict
  * [SETUP-WEB] MOZILLA_PKIX_ERROR_KEY_PINNING_FAILURE ***/
// XXX removed because it is already default or I dont need XXX  user_pref("security.cert_pinning.enforcement_level", 2);
...
// XXX removed because it is already default or I dont need XXX  user_pref("security.remote_settings.crlite_filters.enabled", true);
// XXX removed because it is already default or I dont need XXX  user_pref("security.pki.crlite_mode", 2);
...
// XXX removed because it is already default or I dont need XXX  user_pref("dom.security.https_only_mode", true); // [FF76+]
...
// XXX removed because it is already default or I dont need XXX  user_pref("dom.security.https_only_mode_send_http_background_request", false);
...
// XXX removed because it is already default or I dont need XXX  user_pref("security.ssl.treat_unsafe_negotiation_as_broken", true);
 ...
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "1600 syntax error: the parrot rests in peace!");
 /* 1602: control the amount of cross-origin information to send [FF52+]
  * 0=send full URI (default), 1=scheme+host+port+path, 2=scheme+host+port ***/
// XXX removed because it is already default or I dont need XXX  user_pref("network.http.referer.XOriginTrimmingPolicy", 2);
 
 /*** [SECTION 1700]: CONTAINERS ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "1700 syntax error: the parrot's bit the dust!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "2000 syntax error: the parrot's snuffed it!");
 /* 2002: force WebRTC inside the proxy [FF70+] ***/
// XXX removed because it is already default or I dont need XXX  user_pref("media.peerconnection.ice.proxy_only_if_behind_proxy", true);
 /* 2003: force a single network interface for ICE candidates generation [FF42+]
  * When using a system-wide proxy, it uses the proxy interface
  * [1] https://developer.mozilla.org/docs/Web/API/RTCIceCandidate
  * [2] https://wiki.mozilla.org/Media/WebRTC/Privacy ***/
// XXX removed because it is already default or I dont need XXX  user_pref("media.peerconnection.ice.default_address_only", true);
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "2400 syntax error: the parrot's kicked the bucket!");
 /* 2402: prevent scripts from moving and resizing open windows ***/
// XXX removed because it is already default or I dont need XXX  user_pref("dom.disable_window_move_resize", true);
 
 /*** [SECTION 2600]: MISCELLANEOUS ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "2600 syntax error: the parrot's run down the curtain!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("devtools.debugger.remote-enabled", false); // [DEFAULT: false]
...
// XXX removed because it is already default or I dont need XXX  user_pref("permissions.manager.defaultsUrl", "");
...
// XXX removed because it is already default or I dont need XXX  user_pref("network.IDN_show_punycode", true);
...
// XXX removed because it is already default or I dont need XXX  user_pref("pdfjs.disabled", false); // [DEFAULT: false]
...
// XXX removed because it is already default or I dont need XXX  user_pref("browser.contentanalysis.enabled", false); // [FF121+] [DEFAULT: false]
// XXX removed because it is already default or I dont need XXX  user_pref("browser.contentanalysis.default_result", 0); // [FF127+] [DEFAULT: 0]
...
// XXX removed because it is already default or I dont need XXX  user_pref("extensions.enabledScopes", 5); // [HIDDEN PREF]
    // user_pref("extensions.autoDisableScopes", 15); // [DEFAULT: 15]
 /* 2661: disable bypassing 3rd party extension install prompts [FF82+]
  * [1] https://bugzilla.mozilla.org/buglist.cgi?bug_id=1659530,1681331 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("extensions.postDownloadThirdPartyPrompt", false);
 /* 2662: disable webextension restrictions on certain mozilla domains (you also need 4503) [FF60+]
  * [1] https://bugzilla.mozilla.org/buglist.cgi?bug_id=1384330,1406795,1415644,1453988 ***/
    // user_pref("extensions.webextensions.restrictedDomains", "");
 
 /*** [SECTION 2700]: ETP (ENHANCED TRACKING PROTECTION) ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "2700 syntax error: the parrot's joined the bleedin' choir invisible!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "2800 syntax error: the parrot's bleedin' demised!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.sanitize.sanitizeOnShutdown", true);
 
 /** SANITIZE ON SHUTDOWN: IGNORES "ALLOW" SITE EXCEPTIONS | v2 migration is FF128+ ***/
 /* 2811: set/enforce what items to clear on shutdown (if 2810 is true) [SETUP-CHROME]
  * [NOTE] If "history" is true, downloads will also be cleared ***/
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown.cache", true);     // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown_v2.cache", true);  // [FF128+] [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown.downloads", true); // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown.formdata", true);  // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown.history", true);   // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown_v2.historyFormDataAndDownloads", true); // [FF128+] [DEFAULT: true]
...
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown.cookies", true); // Cookies
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown.offlineApps", true); // Site Data
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown.sessions", true);  // Active Logins [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearOnShutdown_v2.cookiesAndStorage", true); // Cookies, Site Data, Active Logins [FF128+]
 
 /** SANITIZE SITE DATA: IGNORES "ALLOW" SITE EXCEPTIONS ***/
 /* 2820: set manual "Clear Data" items [SETUP-CHROME] [FF128+]
  * Firefox remembers your last choices. This will reset them when you start Firefox
  * [SETTING] Privacy & Security>Browser Privacy>Cookies and Site Data>Clear Data ***/
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearSiteData.cache", true);
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearSiteData.cookiesAndStorage", false); // keep false until it respects "allow" site exceptions
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearSiteData.historyFormDataAndDownloads", true);
...
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.cpd.cache", true);    // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearHistory.cache", true);
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.cpd.formdata", true); // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.cpd.history", true);  // [DEFAULT: true]
    // user_pref("privacy.cpd.downloads", true); // not used, see note above
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearHistory.historyFormDataAndDownloads", true);
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.cpd.cookies", false);
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.cpd.sessions", true); // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.cpd.offlineApps", false); // [DEFAULT: false]
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.clearHistory.cookiesAndStorage", false);
...
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.sanitize.timeSpan", 0);
 ...
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "4000 syntax error: the parrot's bereft of life!");
 ...
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "4500 syntax error: the parrot's popped 'is clogs");
 /* 4501: enable RFP
...
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.window.maxInnerWidth", 1600);
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.window.maxInnerHeight", 900);
 /* 4503: disable mozAddonManager Web API [FF57+]
  * [NOTE] To allow extensions to work on AMO, you also need 2662
  * [1] https://bugzilla.mozilla.org/buglist.cgi?bug_id=1384330,1406795,1415644,1453988 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.resistFingerprinting.block_mozAddonManager", true);
...
// XXX removed because it is already default or I dont need XXX  user_pref("browser.link.open_newwindow", 3); // [DEFAULT: 3]
 /* 4513: set all open window methods to abide by "browser.link.open_newwindow" (4512)
  * [1] https://searchfox.org/mozilla-central/source/dom/tests/browser/browser_test_new_window_from_content.js ***/
// XXX removed because it is already default or I dont need XXX  user_pref("browser.link.open_newwindow.restriction", 0);
 ...
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "5000 syntax error: the parrot's taken 'is last bow");
 ...
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "5500 syntax error: this is an ex-parrot!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "6000 syntax error: the parrot's 'istory!");
 /* 6001: enforce Firefox blocklist
  * [WHY] It includes updates for "revoked certificates"
  * [1] https://blog.mozilla.org/security/2015/03/03/revoking-intermediate-certificates-introducing-onecrl/ ***/
// XXX removed because it is already default or I dont need XXX  user_pref("extensions.blocklist.enabled", true); // [DEFAULT: true]
 /* 6002: enforce no referer spoofing
  * [WHY] Spoofing can affect CSRF (Cross-Site Request Forgery) protections ***/
// XXX removed because it is already default or I dont need XXX  user_pref("network.http.referer.spoofSource", false); // [DEFAULT: false]
 /* 6004: enforce a security delay on some confirmation dialogs such as install, open/save
  * [1] https://www.squarefree.com/2004/07/01/race-conditions-in-security-dialogs/ ***/
// XXX removed because it is already default or I dont need XXX  user_pref("security.dialog_enable_delay", 1000); // [DEFAULT: 1000]
...
// XXX removed because it is already default or I dont need XXX  user_pref("privacy.firstparty.isolate", false); // [DEFAULT: false]
 /* 6009: enforce SmartBlock shims (about:compat) [FF81+]
  * [1] https://blog.mozilla.org/security/2021/03/23/introducing-smartblock/ ***/
// XXX removed because it is already default or I dont need XXX  user_pref("extensions.webcompat.enable_shims", true); // [HIDDEN PREF] [DEFAULT: true]
 /* 6010: enforce no TLS 1.0/1.1 downgrades
  * [TEST] https://tls-v1-1.badssl.com:1010/ ***/
// XXX removed because it is already default or I dont need XXX  user_pref("security.tls.version.enable-deprecated", false); // [DEFAULT: false]
 /* 6011: enforce disabling of Web Compatibility Reporter [FF56+]
  * Web Compatibility Reporter adds a "Report Site Issue" button to send data to Mozilla
  * [WHY] To prevent wasting Mozilla's time with a custom setup ***/
// XXX removed because it is already default or I dont need XXX  user_pref("extensions.webcompat-reporter.enabled", false); // [DEFAULT: false]
 /* 6012: enforce Quarantined Domains [FF115+]
  * [WHY] https://support.mozilla.org/kb/quarantined-domains */
// XXX removed because it is already default or I dont need XXX  user_pref("extensions.quarantinedDomains.enabled", true); // [DEFAULT: true]
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "7000 syntax error: the parrot's pushing up daisies!");
 /* 7001: disable APIs
 ...
 ***/
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "8000 syntax error: the parrot's crossed the Jordan");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "9000 syntax error: the parrot's cashed in 'is chips!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "9999 syntax error: the parrot's shuffled off 'is mortal coil!");
...
// XXX removed because it is already default or I dont need XXX  user_pref("_user.js.parrot", "SUCCESS: No no he's not dead, he's, he's restin'!");
 // PERSONAL PREFS
