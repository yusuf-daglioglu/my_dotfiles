...
// XXX removed because it is already default or I dont need XXX user_pref("security.webauthn.always_allow_direct_attestation", false); // [DEFAULT: false]
...
// XXX removed because it is already default or I dont need XXX user_pref("security.remote_settings.crlite_filters.enabled", true); // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX user_pref("security.pki.crlite_mode", 2); // [DEFAULT: 2 FF142+]
...
// XXX removed because it is already default or I dont need XXX user_pref("privacy.trackingprotection.allow_list.baseline.enabled", true); // [DEFAULT: true]
// XXX removed because it is already default or I dont need XXX user_pref("privacy.trackingprotection.allow_list.convenience.enabled", true); // [DEFAULT: true]
...
// XXX removed because it is already default or I dont need XXX user_pref("privacy.clearSiteData.cache", true); // [DEFAULT: true]
