...
function ___generateRandomIntegerByCharLength(minLength, maxLength) {
    ...
    if (!isPositive(minLength) && !isPositive(maxLength)) {
        lengthOfString = 4;
    } else if (isPositive(minLength) && !isPositive(maxLength)) {
        lengthOfString = minLength;
    } else if (!isPositive(minLength) && isPositive(maxLength)) {

        if (maxLength > 4) {
            lengthOfString = 4;
        } else {
            lengthOfString = maxLength;
        }
    ...
    return ___generateRandomNumberWithLength(lengthOfString);
}

function ___generateRandomNumberWithLength(staticLength) {

    if (staticLength == 3) {
        return ___generateRandomInteger(100, 999);
    } else if (staticLength == 2) {
        return ___generateRandomInteger(10, 99);
    } else if (staticLength == 1) {
...
function ___maxLengthToMaxNumber(maxLength) {
