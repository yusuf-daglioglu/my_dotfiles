...
Tıklandığında; Toolbox’un ortasında, “Tool Options” sekmesinin hemen üstündeki 2 kutucukta, seçtiğimiz renk gözükecektir. Artık kalem veya başka bir özelliğin button'una tıklandığında bu renk hala aktifliğini koruyacaktır.
