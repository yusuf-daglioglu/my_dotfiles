...
- Use SimpleX as note taking app. because it creates saparete users for mobile and desktop. so if one of them corrupts, you can still use other device as backup.

- Syncthing oficial Android client has been abandoned. This is a new fork of it: <https://github.com/Catfriend1/syncthing-android>
