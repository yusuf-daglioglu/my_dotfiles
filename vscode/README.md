...
- NOT INCLUDED: settings.json (use "__profile_settings.json__")
- NOT INCLUDED: global-state (other settings like UI button visibility)

### DEFAULT THEME

"__Default theme__" is built-in theme-extension (with id: __vscode.theme-defaults__) and it can be disabled. But if it's disabled then syntax-highlighting features may not work.
