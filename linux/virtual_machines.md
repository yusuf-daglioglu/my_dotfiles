...
It is good to use default directories because permission management is complex. Even if you give the ISO file 777 permission, the user and group should be compatible with VM initializer. Also all the parent directories should have the correct permissions.
