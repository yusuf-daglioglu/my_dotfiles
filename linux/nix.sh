...
# su $NIX_USER_NAME -c "/home/$NIX_USER_NAME/.nix-profile/bin/nix-shell -p kdePackages.partitionmanager"
...
# kde partition mananager but it does not work:
# sudo /nix/store/d21pq3dg762j6z3gafhfxmhxa9c3ybbx-partitionmanager-25.08.3/bin/partitionmanager
...
'/nix/store/ll8r2455s5r7kvbg2b54kynnq09jv0ig-git-with-svn-2.51.2/bin/git' gui
'/nix/store/ll8r2455s5r7kvbg2b54kynnq09jv0ig-git-with-svn-2.51.2/bin/gitk'
