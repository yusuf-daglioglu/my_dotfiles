...
XXX_CONTAINER_NAME=toolbox_blivet-gui
XXX_HOME_DIR=/run/media/user1/internal1/home/blivet-gui
...
$XXX_DISTROBOX_DIR/distrobox \
      create \
      --init-hooks "dnf -y install blivet-gui" \
      --root \
